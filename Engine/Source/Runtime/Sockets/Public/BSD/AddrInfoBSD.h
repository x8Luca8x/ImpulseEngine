...
public:
	 ...
	 */
	virtual void SetIp(const in_addr& InAddr);
	...
	virtual void SetIp(const in6_addr& InAddr);
...
public:
	...
	FInternetAddrBSD();
	FInternetAddrBSD(FName RequestedProtocol = NAME_None);
	 ...
	 */
	virtual TSharedPtr<FInternetAddr> Clone() const override;
